...
Our SVC classification model performed well on the testing data, with accuracy(test score) of `{python} test_score` and a training score of `{python} train_score`.
